...
resource "azurerm_kubernetes_cluster" "main" {
  ...
  dns_prefix = var.prefix == "" ? null : var.prefix
  ...
  dynamic "api_server_access_profile" {
    ...
    content {
      ...
      # subnet_id            = var.api_server_subnet_id # deprecated
    }
  }
  ...
  dynamic "ingress_application_gateway" {
    ...
    content {
      gateway_name = try(var.application_gateway_for_ingress.name, null)
      subnet_cidr  = try(var.application_gateway_for_ingress.subnet_cidr, null)
      subnet_id    = try(var.application_gateway_for_ingress.subnet_id, null)
    }
  }
  ...
  #   for_each = var.web_app_routing_identity != {} ? var.web_app_routing_identity : {}
  ...
  lifecycle {
    ignore_changes = [
      ...
      kubernetes_version,
      #   public_network_access_enabled, ## warning
