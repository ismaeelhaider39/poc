variable "resource_group_name" {
  type        = string
  description = "The resource group name in which AKS will be created"
}
...
variable "acr_id" {
  type        = string
  default     = null
  description = "(Optional) The ID of the ACR"
}
...
variable "ingress_application_gateway_enabled" {
  type = bool
  default = true
  description = "Should the application gateway for the ingress should be enabled? Defaults to true."
}
...
EOT
  ...
  validation {
    condition     = var.application_gateway_for_ingress == null ? true : (can(coalesce(var.application_gateway_for_ingress.subnet_id, var.application_gateway_for_ingress.subnet_cidr)))
...
# variable "web_app_routing_identity" {
#   type = object({
#     client_id = string
#     object_id = string
...
#   type = string
#   description = "Specifies parent ID of User Assigned Identity for this Federated Identity Credential. Changing this forces a new Federated Identity Credential to be created."
# }
